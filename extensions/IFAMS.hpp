 ...
 */
class IFAMS : public Strategy
                         , public ProcessNackTraits<IFAMS>
{
public:
  explicit
  IFAMS(Forwarder& forwarder, const Name& name = getStrategyName());
...
PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<IFAMS>;

private:
  MaliciousVehicleTable m_RIT;
};
