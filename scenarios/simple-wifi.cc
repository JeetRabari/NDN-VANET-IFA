...
main(int argc, char* argv[])
{
  ...
  ndn::StrategyChoiceHelper::Install(nodes, "/", "/localhost/nfd/strategy/broadcast");

  // 4. Set up applications
  NS_LOG_INFO("Installing Applications");

  TimeValue stop_time = Seconds(100.0);

  ndn::AppHelper consumerHelper("ns3::ndn::ConsumerCbrFifa");
  consumerHelper.SetPrefix("/test/prefix");
  consumerHelper.SetAttribute("Frequency", DoubleValue(10.0));
  consumerHelper.SetAttribute("StopTime", stop_time);
